...
#to install cuda toolkit (make sure to download the right installer, go this website: https://developer.nvidia.com/cuda-downloads)
wwget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2004/x86_64/cuda-ubuntu2004.pin
